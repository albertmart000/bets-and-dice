...
import com.betsanddice.auth.helper.ResourceHelper;
...
class UserTest {
    ...
    void rightDeserializationTest() {
        ...
        User dtoResult = mapper.readValue(challengeJsonSource, User.class);
        assertThat(dtoResult).usingRecursiveComparison().isEqualTo(user);
    }
