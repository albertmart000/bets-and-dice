...
@Service
public class CrapsClientServiceImpl implements ICrapsClientService {
    ...
    public CrapsClientServiceImpl(UserRepository userRepository, StringToUuidValidator uuidValidator, WebClient webClient) {
