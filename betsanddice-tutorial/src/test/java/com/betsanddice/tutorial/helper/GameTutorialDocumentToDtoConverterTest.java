...
class GameTutorialDocumentToDtoConverterTest {
    ...
    public void setup() {
        ...
        gameTutorialDocument1 = new GameTutorialDocument(uuidGameTutorial1, "Craps", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur...");
        gameTutorialDocument2 = new GameTutorialDocument(uuidGameTutorial2, "SixDice", "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt...");


        gameTutorialDto1 = getGameTutorialDtoMocked(uuidGameTutorial1, "Craps", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur...");
        gameTutorialDto2 = getGameTutorialDtoMocked(uuidGameTutorial2, "SixDice", "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt...");
    ...
    private GameTutorialDto getGameTutorialDtoMocked(UUID uuidGameTutorial, String gameName, String rules) {
        GameTutorialDto gameTutorialDtoMocked = mock(GameTutorialDto.class);
        when(gameTutorialDtoMocked.getGameId()).thenReturn(uuidGameTutorial);
